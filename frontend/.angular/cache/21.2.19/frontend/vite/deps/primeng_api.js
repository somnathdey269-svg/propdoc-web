import {
  CommonModule
} from "./chunk-RBAYP3GK.js";
import "./chunk-ZPSCYRHU.js";
import {
  Component,
  Directive,
  Injectable,
    ...
    if (f !== a) i = false;
      ...
      if (y !== k) i = false;
        ...
        if (w !== Object.keys(t).length) i = false;
          ...
          for (let h = w; h-- !== 0; ) if (!Object.prototype.hasOwnProperty.call(t, g2[h])) {
            i = false;
            break;
          }
...
function g() {
  ...
  }, a = (e, n) => u(e, n).value, u = (e, n, t = 0) => [...r].reverse().find((s) => n ? true : s.key === e) || { key: e, value: t }, l2 = (e) => e && parseInt(e.style.zIndex, 10) || 0;
