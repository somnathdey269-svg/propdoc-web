 ...
 */
interface TieredMenuProcessedItem {
    /**
     * Menu item instance.
     */
    item: MenuItem;
 ...
 */
interface TieredMenuFocusedItemInfo {
    /**
 ...
 * @group Interface
 */
interface TieredMenuItemClickEvent {
    /**
     * Browser event.
     */
    originalEvent: Event;
 ...
 * @group Interface
 */
interface TieredMenuItemMouseEnterEvent {
    /**
     * Browser event.
     */
    originalEvent: Event;
 ...
 * @group Interface
 */
interface TieredMenuToggleEvent {
    /**
...
export type { TieredMenuFocusedItemInfo, TieredMenuItemClickEvent, TieredMenuItemMouseEnterEvent, TieredMenuItemTemplateContext, TieredMenuPassThrough, TieredMenuPassThroughOptions, TieredMenuProcessedItem, TieredMenuTemplates, TieredMenuToggleEvent };
