 ...
 * @group Events
 */
interface MenubarItemClickEvent {
    originalEvent: Event;
 ...
 * @group Events
 */
interface MenubarItemMouseEnterEvent {
    originalEvent: Event;
    processedItem: ProcessedMenuItem;
}
/**
...
export type { FocusedItemInfo, MenubarInlineStyles, MenubarItemClickEvent, MenubarItemMouseEnterEvent, MenubarItemTemplateContext, MenubarPassThrough, MenubarPassThroughOptions, MenubarTemplates, ProcessedMenuItem };
