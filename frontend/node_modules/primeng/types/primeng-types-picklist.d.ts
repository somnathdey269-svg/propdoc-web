...
interface PickListTemplates {
    /**
     * Custom item template shared by both lists. Used as a fallback when a list-specific template is not defined.
    ...
    /**
     * Custom source item template, takes precedence over the shared item template for the source list.
     * @param {PickListItemTemplateContext} context - item context.
     */
    sourceItem(context: PickListItemTemplateContext): TemplateRef<PickListItemTemplateContext>;
    /**
     * Custom target item template, takes precedence over the shared item template for the target list.
     * @param {PickListItemTemplateContext} context - item context.
     */
    targetItem(context: PickListItemTemplateContext): TemplateRef<PickListItemTemplateContext>;
    /**
