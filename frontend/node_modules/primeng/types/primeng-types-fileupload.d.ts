...
import { MessageSeverity, MessagePassThrough } from 'primeng/types/message';
 ...
 * @group Interface
 */
interface FileContentRemoveEvent {
    /**
     * Browser event.
     */
    event: Event;
 ...
 * @group Interface
 */
interface FileRemoveIconTemplateContext {
    /**
 ...
 * @group Interface
 */
interface FileUploadFileTemplateContext {
    /**
     * The file.
     */
    $implicit: File;
...
export type { FileBeforeUploadEvent, FileContentRemoveEvent, FileProgressEvent, FileRemoveEvent, FileRemoveIconTemplateContext, FileSelectEvent, FileSendEvent, FileUploadContentTemplateContext, FileUploadErrorEvent, FileUploadEvent, FileUploadFileLabelTemplateContext, FileUploadFileTemplateContext, FileUploadHandlerEvent, FileUploadHeaderTemplateContext, FileUploadMessage, FileUploadPassThrough, FileUploadPassThroughOptions, FileUploadTemplates, FormDataEvent, RemoveUploadedFileEvent, UploadEvent };
