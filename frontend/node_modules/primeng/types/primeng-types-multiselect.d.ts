 ...
 * @group Events
 */
interface MultiSelectItemClickEvent<T = any> {
    /**
     * Browser event.
     */
    originalEvent: Event;
 ...
 * @group Events
 */
interface MultiSelectItemMouseEnterEvent<T = any> {
    /**
     * Browser event.
     */
    originalEvent: Event;
...
export type { MultiSelectBlurEvent, MultiSelectChangeEvent, MultiSelectChipIconTemplateContext, MultiSelectDisplay, MultiSelectDropdownIconTemplateContext, MultiSelectFilterEvent, MultiSelectFilterOptions, MultiSelectFilterTemplateContext, MultiSelectFocusEvent, MultiSelectGroupTemplateContext, MultiSelectHeaderCheckboxIconTemplateContext, MultiSelectItemCheckboxIconTemplateContext, MultiSelectItemClickEvent, MultiSelectItemMouseEnterEvent, MultiSelectItemTemplateContext, MultiSelectLazyLoadEvent, MultiSelectLoaderTemplateContext, MultiSelectPassThrough, MultiSelectPassThroughOptions, MultiSelectRemoveEvent, MultiSelectSelectAllChangeEvent, MultiSelectSelectedItemsTemplateContext, MultiSelectTemplates };
