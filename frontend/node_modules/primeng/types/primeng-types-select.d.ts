 ...
 * @group Interface
 */
interface SelectHeaderTemplateContext {
    /**
...
interface SelectTemplates<T = any> {
     ...
     */
    header(context: SelectHeaderTemplateContext): TemplateRef<SelectHeaderTemplateContext>;
    /**
...
export type { SelectChangeEvent, SelectFilterEvent, SelectFilterOptions, SelectFilterTemplateContext, SelectGroupTemplateContext, SelectHeaderTemplateContext, SelectIconTemplateContext, SelectItemTemplateContext, SelectLazyLoadEvent, SelectLoaderTemplateContext, SelectPassThrough, SelectPassThroughOptions, SelectSelectedItemTemplateContext, SelectTemplates };
