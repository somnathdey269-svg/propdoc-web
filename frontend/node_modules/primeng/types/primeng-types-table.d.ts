...
import { ButtonPassThrough, ButtonDirectiveOptions } from 'primeng/types/button';
...
type TableColumnResizeMode = 'fit' | 'expand';
type TableStateStorage = 'session' | 'local';
type TableEditMode = 'cell' | 'row';
type TableSize = 'small' | 'large';
type TableRowExpandMode = 'multiple' | 'single';
type TableRowGroupMode = 'subheader' | 'rowspan';
/**
...
interface TableFilterEvent {
    /**
     * Filter meta. Column filters emit a `FilterMetadata[]` per field (one entry per constraint);
     * the legacy `filter()` API emits a single `FilterMetadata`. Read defensively, e.g.
     * `const meta = Array.isArray(f) ? f[0] : f;`.
     */
    filters?: {
...
interface TableFilterButtonPopoverPropsOptions {
     ...
     */
    addRule: ButtonDirectiveOptions | undefined;
    /**
     * Remove rule button props
     */
    removeRule: ButtonDirectiveOptions | undefined;
    /**
     * Apply button props
     */
    apply: ButtonDirectiveOptions | undefined;
    /**
     * Apply button props
     */
    clear: ButtonDirectiveOptions | undefined;
}
/**
...
interface TableFilterButtonPropsOptions {
     ...
     * Filter button props
     */
    filter: ButtonDirectiveOptions | undefined;
    /**
...
export type { ColumnFilterPassThrough, ColumnFilterPassThroughOptions, ExportCSVOptions, TableColResizeEvent, TableColumnReorderEvent, TableColumnResizeMode, TableContextMenuSelectEvent, TableContextMenuSelectionChangeEvent, TableEditCancelEvent, TableEditCompleteEvent, TableEditEvent, TableEditInitEvent, TableEditMode, TableFilterButtonInlinePropsOptions, TableFilterButtonPopoverPropsOptions, TableFilterButtonPropsOptions, TableFilterEvent, TableHeaderCheckboxToggleEvent, TableLazyLoadEvent, TablePageEvent, TablePaginatorPosition, TablePassThrough, TablePassThroughOptions, TableRowCollapseEvent, TableRowExpandEvent, TableRowExpandMode, TableRowGroupMode, TableRowReorderEvent, TableRowSelectEvent, TableRowUnSelectEvent, TableSelectAllChangeEvent, TableSelectionMode, TableSize, TableSortMode, TableStateStorage, TableTemplates };
