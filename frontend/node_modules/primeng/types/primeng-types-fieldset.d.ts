...
interface FieldsetTemplates {
     ...
     * @param {FieldsetToggleIconTemplateContext} context - toggler icon context.
     */
    toggleicon(context: FieldsetToggleIconTemplateContext): TemplateRef<FieldsetToggleIconTemplateContext>;
    /**
...
/**
 * Context of the toggler icon template.
 * @group Interface
 */
interface FieldsetToggleIconTemplateContext {
    /**
...
export type { FieldsetAfterToggleEvent, FieldsetBeforeToggleEvent, FieldsetPassThrough, FieldsetPassThroughOptions, FieldsetTemplates, FieldsetToggleIconTemplateContext };
