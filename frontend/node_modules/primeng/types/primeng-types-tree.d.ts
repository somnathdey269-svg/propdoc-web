 ...
 */
type TreeSelectionMode = 'single' | 'multiple' | 'checkbox' | null | undefined;
/**
 * Defines the loading mode of the tree.
 */
type TreeLoadingMode = 'mask' | 'icon';
/**
...
interface TreeNodeDropEvent {
    ...
    index?: number;
    /**
     * Indicates if the node is dropped onto a node (`'node'`) or in a drop point
...
export type { TreeCheckboxIconTemplateContext, TreeFilterEvent, TreeFilterTemplateContext, TreeLazyLoadEvent, TreeLoaderTemplateContext, TreeLoadingMode, TreeNodeCollapseEvent, TreeNodeContextMenuSelectEvent, TreeNodeDoubleClickEvent, TreeNodeDropEvent, TreeNodeExpandEvent, TreeNodeSelectEvent, TreeNodeUnSelectEvent, TreePassThrough, TreePassThroughOptions, TreeScrollEvent, TreeScrollIndexChangeEvent, TreeSelectionMode, TreeTemplates, TreeTogglerIconTemplateContext };
