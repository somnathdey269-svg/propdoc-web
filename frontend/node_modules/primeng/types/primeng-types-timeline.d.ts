 ...
 */
type TimelineAlign = 'left' | 'right' | 'top' | 'bottom' | 'alternate';
/**
...
export type { TimelineAlign, TimelineItemTemplateContext, TimelineLayout, TimelinePassThrough, TimelinePassThroughOptions, TimelineTemplates };
