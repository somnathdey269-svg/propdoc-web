 ...
 * @group Types
 */
type TreeTablePaginatorPosition = 'top' | 'bottom' | 'both';
/**
 * Defines the sort mode.
 * @group Types
 */
type TreeTableSortMode = 'single' | 'multiple';
/**
 * Defines the selection mode.
 * @group Types
 */
type TreeTableSelectionMode = 'single' | 'multiple' | 'checkbox';
/**
 * Defines the algorithm to compare selections.
 * @group Types
 */
type TreeTableCompareSelectionBy = 'equals' | 'deepEquals';
/**
 * Defines the column resize mode.
 * @group Types
 */
type TreeTableColumnResizeMode = 'fit' | 'expand';
/**
 * Defines the filter mode.
 * @group Types
 */
type TreeTableFilterMode = 'lenient' | 'strict';
/**
...
export type { TreeTableBodyTemplateContext, TreeTableCheckboxIconTemplateContext, TreeTableColResizeEvent, TreeTableColumnReorderEvent, TreeTableColumnResizeMode, TreeTableColumnsTemplateContext, TreeTableCompareSelectionBy, TreeTableContextMenuSelectEvent, TreeTableEditEvent, TreeTableEmptyMessageTemplateContext, TreeTableFilterEvent, TreeTableFilterMode, TreeTableFilterOptions, TreeTableHeaderCheckboxIconTemplateContext, TreeTableHeaderCheckboxToggleEvent, TreeTableLazyLoadEvent, TreeTableNodeCollapseEvent, TreeTableNodeExpandEvent, TreeTableNodeSelectEvent, TreeTableNodeUnSelectEvent, TreeTablePaginatorPosition, TreeTablePaginatorState, TreeTablePassThrough, TreeTablePassThroughOptions, TreeTableSelectionMode, TreeTableSortEvent, TreeTableSortIconTemplateContext, TreeTableSortMode, TreeTableTemplates, TreeTableTogglerIconTemplateContext };
