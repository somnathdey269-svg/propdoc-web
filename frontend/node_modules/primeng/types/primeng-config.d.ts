...
import { AccordionPassThrough, AccordionPanelPassThrough, AccordionHeaderPassThrough, AccordionContentPassThrough } from 'primeng/types/accordion';
...
import { CarouselPassThrough, CarouselContentPassThrough, CarouselItemPassThrough, CarouselIndicatorsPassThrough, CarouselNextPassThrough, CarouselPrevPassThrough, CarouselIndicatorPassThrough } from 'primeng/types/carousel';
...
import { CommandMenuPassThrough } from 'primeng/types/commandmenu';
...
import { GalleryPassThrough, GalleryBackdropPassThrough, GalleryHeaderPassThrough, GalleryContentPassThrough, GalleryFooterPassThrough, GalleryItemPassThrough, GalleryPrevPassThrough, GalleryNextPassThrough, GalleryZoomInPassThrough, GalleryZoomOutPassThrough, GalleryZoomTogglePassThrough, GalleryRotateLeftPassThrough, GalleryRotateRightPassThrough, GalleryFlipXPassThrough, GalleryFlipYPassThrough, GalleryDownloadPassThrough, GalleryFullScreenPassThrough, GalleryThumbnailPassThrough, GalleryThumbnailContentPassThrough, GalleryThumbnailItemPassThrough, GalleryToolbarPassThrough, GalleryToolbarItemPassThrough } from 'primeng/types/gallery';
...
import { InputColorPassThrough, InputColorAreaPassThrough, InputColorAreaBackgroundPassThrough, InputColorAreaHandlePassThrough, InputColorSliderPassThrough, InputColorSliderTrackPassThrough, InputColorSliderHandlePassThrough, InputColorSwatchPassThrough, InputColorSwatchBackgroundPassThrough, InputColorTransparencyGridPassThrough, InputColorEyeDropperPassThrough } from 'primeng/types/inputcolor';
...
interface GlobalPassThrough {
    ...
    inputColorAreaHandle?: InputColorAreaHandlePassThrough;
    inputColorSlider?: InputColorSliderPassThrough;
    inputColorSliderTrack?: InputColorSliderTrackPassThrough;
    inputColorSliderHandle?: InputColorSliderHandlePassThrough;
...
declare class PrimeNG extends ThemeProvider {
    ...
    private _verified;
    readonly verified: _angular_core.Signal<boolean | null>;
    _setVerified(value: boolean): void;
    overlayAppendTo: _angular_core.WritableSignal<AppendTo>;
    overlayOptions: OverlayOptions;
    csp: _angular_core.WritableSignal<{
        nonce: string | undefined;
    }>;
