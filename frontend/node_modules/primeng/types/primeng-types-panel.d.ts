 ...
 * @group Types
 */
type PanelIconPos = 'start' | 'end' | 'center';
/**
 * Defines the toggler element for Panel component.
 * @group Types
 */
type PanelToggler = 'icon' | 'header';
/**
...
export type { PanelAfterToggleEvent, PanelBeforeToggleEvent, PanelHeaderIconsTemplateContext, PanelIconPos, PanelPassThrough, PanelPassThroughOptions, PanelTemplates, PanelToggler };
