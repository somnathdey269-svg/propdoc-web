...
import * as primeng_dialog from 'primeng/dialog';
...
import { DialogPosition, DialogPassThrough } from 'primeng/types/dialog';
...
declare class DynamicDialog extends BaseComponent<DialogPassThrough$1> {
    ...
    ddconfig: DynamicDialogConfig<any, any>;
    dialogRef: DynamicDialogRef<any>;
    onAfterViewChecked(): void;
    visible: i0.WritableSignal<boolean>;
    componentRef: Nullable<ComponentRef<object>>;
    id: string;
    insertionPoint: i0.Signal<DynamicDialogContent | undefined>;
    dialog: i0.Signal<Dialog | undefined>;
    ...
    get position(): primeng_dialog.DialogPosition | undefined;
    ...
    get motionOptions(): _primeuix_motion.MotionOptions | undefined;
    get maskMotionOptions(): _primeuix_motion.MotionOptions | undefined;
    get closeButtonProps(): ButtonDirectiveOptions;
    get maximizeButtonProps(): ButtonDirectiveOptions;
    ...
    contentViewChild: HTMLElement | null;
    footerViewChild: HTMLElement | null;
    headerViewChild: HTMLElement | null;
    maskViewChild: HTMLElement | null;
    ...
    loadChildComponent(componentType: Type<object>): void;
    onDialogHide(): void;
    ...
    onDialogDragStart(event: MouseEvent): void;
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<DynamicDialog, "p-dynamicdialog, p-dynamic-dialog", never, {}, {}, never, never, true, [{ directive: typeof i1.Bind; inputs: {}; outputs: {}; }]>;
}
