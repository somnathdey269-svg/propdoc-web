 ...
 * @group Types
 */
type TreeSelectDisplay = 'comma' | 'chip';
/**
 * Defines the selection mode.
 * @group Types
 */
type TreeSelectSelectionMode = 'single' | 'multiple' | 'checkbox';
/**
 * Defines the loading mode display.
 * @group Types
 */
type TreeSelectLoadingMode = 'mask' | 'icon';
/**
...
export type { TreeSelectDisplay, TreeSelectHeaderTemplateContext, TreeSelectItemCheckboxIconTemplateContext, TreeSelectItemTogglerIconTemplateContext, TreeSelectLoadingMode, TreeSelectNodeCollapseEvent, TreeSelectNodeExpandEvent, TreeSelectPassThrough, TreeSelectPassThroughOptions, TreeSelectSelectionMode, TreeSelectTemplates, TreeSelectValueTemplateContext };
