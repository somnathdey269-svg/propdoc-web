 ...
 * @group Interface
 */
interface ColorPickerPassThroughOptions<I = unknown> {
    /**
 ...
 * @group Interface
 */
type ColorPickerPassThrough<I = unknown> = PassThrough<I, ColorPickerPassThroughOptions<I>>;
/**
 * Custom change event.
...
export type { ColorPickerChangeEvent, ColorPickerFormat, ColorPickerPassThrough, ColorPickerPassThroughOptions };
