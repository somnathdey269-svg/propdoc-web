...
/**
 * Defines the layout mode for the Toast.
 ...
 */
type ToastModeType = 'stacked' | 'expanded';
/**
 ...
 * @group Types
 */
type ToastBreakpoints = Record<string, Partial<CSSStyleDeclaration>>;
/**
 * Custom close event.
...
export type { ToastBreakpoints, ToastCloseEvent, ToastHeadlessTemplateContext, ToastItemCloseEvent, ToastMessageTemplateContext, ToastModeType, ToastPassThrough, ToastPassThroughOptions, ToastPositionType, ToastTemplates };
