...
/**
 * Defines the scrolling behavior when the active tab changes.
 * @group Types
 */
type TabsScrollStrategy = 'nearest' | 'center' | false;
/**
...
export type { TabListPassThrough, TabListPassThroughOptions, TabPanelPassThrough, TabPanelPassThroughOptions, TabPanelsPassThrough, TabPanelsPassThroughOptions, TabPassThrough, TabPassThroughOptions, TabsPassThrough, TabsPassThroughOptions, TabsScrollStrategy };
