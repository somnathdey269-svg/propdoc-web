 ...
 * @group Types
 */
type InputNumberMode = 'decimal' | 'currency' | 'percent' | 'unit';
/**
 * Defines the currency display style of the InputNumber component.
 * @group Types
 */
type InputNumberCurrencyDisplay = 'symbol' | 'code' | 'name' | 'narrowSymbol';
/**
 * Defines the locale matching algorithm of the InputNumber component.
 * @group Types
 */
type InputNumberLocaleMatcher = 'lookup' | 'best fit';
/**
...
export type { InputNumberButtonLayout, InputNumberCurrencyDisplay, InputNumberInputEvent, InputNumberLocaleMatcher, InputNumberMode, InputNumberPassThrough, InputNumberPassThroughOptions, InputNumberTemplates };
