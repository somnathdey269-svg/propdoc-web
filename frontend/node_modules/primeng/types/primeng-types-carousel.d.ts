 ...
 * @group Interface
 */
interface CarouselContentPassThroughOptions<I = unknown> {
    /**
     * Used to pass attributes to the root's DOM element.
     */
 ...
 * @template I Type of instance.
 */
type CarouselContentPassThrough<I = unknown> = PassThrough<I, CarouselContentPassThroughOptions<I>>;
/**
 * Defines valid pass-through options in CarouselItem component.
 * @template I Type of instance.
 * @group Interface
 */
interface CarouselItemPassThroughOptions<I = unknown> {
    /**
     * Used to pass attributes to the root's DOM element.
     */
    root?: PassThroughOption<HTMLElement, I>;
 ...
 * @template I Type of instance.
 */
type CarouselItemPassThrough<I = unknown> = PassThrough<I, CarouselItemPassThroughOptions<I>>;
/**
 * Defines valid pass-through options in CarouselIndicators component.
 * @template I Type of instance.
 * @group Interface
 */
interface CarouselIndicatorsPassThroughOptions<I = unknown> {
    /**
     * Used to pass attributes to the root's DOM element.
     */
    root?: PassThroughOption<HTMLElement, I>;
 ...
 * @template I Type of instance.
 */
type CarouselIndicatorsPassThrough<I = unknown> = PassThrough<I, CarouselIndicatorsPassThroughOptions<I>>;
/**
 * Defines valid pass-through options in CarouselNext directive.
 * @template I Type of instance.
 * @group Interface
 */
interface CarouselNextPassThroughOptions<I = unknown> {
    /**
     * Used to pass attributes to the root's DOM element.
     */
    root?: PassThroughOption<HTMLElement, I>;
 ...
 * @template I Type of instance.
 */
type CarouselNextPassThrough<I = unknown> = PassThrough<I, CarouselNextPassThroughOptions<I>>;
/**
 * Defines valid pass-through options in CarouselPrev directive.
 * @template I Type of instance.
 * @group Interface
 */
interface CarouselPrevPassThroughOptions<I = unknown> {
    /**
     * Used to pass attributes to the root's DOM element.
     */
    root?: PassThroughOption<HTMLElement, I>;
 ...
 * @template I Type of instance.
 */
type CarouselPrevPassThrough<I = unknown> = PassThrough<I, CarouselPrevPassThroughOptions<I>>;
/**
 * Defines valid pass-through options in CarouselIndicator directive.
 * @template I Type of instance.
 * @group Interface
 */
interface CarouselIndicatorPassThroughOptions<I = unknown> {
    /**
     * Used to pass attributes to the root's DOM element.
     */
    root?: PassThroughOption<HTMLElement, I>;
 ...
 * @template I Type of instance.
 */
type CarouselIndicatorPassThrough<I = unknown> = PassThrough<I, CarouselIndicatorPassThroughOptions<I>>;

export type { CarouselContentPassThrough, CarouselContentPassThroughOptions, CarouselIndicatorPassThrough, CarouselIndicatorPassThroughOptions, CarouselIndicatorsPassThrough, CarouselIndicatorsPassThroughOptions, CarouselItemPassThrough, CarouselItemPassThroughOptions, CarouselItemTemplateContext, CarouselNextPassThrough, CarouselNextPassThroughOptions, CarouselOrientation, CarouselPageEvent, CarouselPassThrough, CarouselPassThroughOptions, CarouselPrevPassThrough, CarouselPrevPassThroughOptions, CarouselResponsiveOptions, CarouselTemplates };
