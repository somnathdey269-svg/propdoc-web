...
[![PrimeNG Hero](https://www.primefaces.org/static/social/primeng-preview.jpg)](https://primeng.dev)

# PrimeNG Website

PrimeNG is a rich set of premium UI Components for Angular. Visit the [PrimeNG website](https://primeng.dev/) for interactive demos, comprehensive documentation and additional resources.
