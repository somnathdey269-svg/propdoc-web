...
class ArrowDownRightIcon extends BaseIcon {
    static ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "22.0.6", ngImport: i0, type: ArrowDownRightIcon, deps: null, target: i0.ɵɵFactoryTarget.Component });
    static ɵcmp = i0.ɵɵngDeclareComponent({ minVersion: "14.0.0", version: "22.0.6", type: ArrowDownRightIcon, isStandalone: true, selector: "[data-p-icon=\"arrow-down-right\"]", usesInheritance: true, ngImport: i0, template: `
        <svg:path
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "22.0.6", ngImport: i0, type: ArrowDownRightIcon, decorators: [{
            type: Component,
            args: [{
